...
use test_roundtrip::ocaml::CompilationUnit;
use test_roundtrip::parse_ocaml;
use treesitter_types::FromNode;

fn main() {
    let dir = std::env::args()
        .nth(1)
        .expect("usage: parse_all_ocaml <directory>");
    ...
    for entry in walk_files(&dir, "ml") {
        total += 1;
